...
'''
see results of best hidden layers in /data/params_scaler_selection
...
'''
max_neurons = 3  # any desired value
...
only keep the best one. see results in /data/params_scaler_selection
'''
search_space = {
    'standard': list(
        ParameterGrid({
...
for dataset_name, dataset in [
    ...
    labels = dataset['labels'][:testing_samples]
    ...
    for scaler_name, scaler in [
        ...
        for params in search_space[scaler_name]:
    ...
    path = 'data/params_scaler_selection/' + version + '/' + dataset_name
